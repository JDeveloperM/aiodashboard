...
export function AnalyticsPanel({
  ...
  const barData = [
    { month: 'Jan', affiliate: 12000, royalties: 2400, pLevel10: 1200, treasury: 6000 },
    { month: 'Feb', affiliate: 15000, royalties: 3000, pLevel10: 1500, treasury: 7500 },
    { month: 'Mar', affiliate: 18000, royalties: 3600, pLevel10: 1800, treasury: 9000 },
    { month: 'Apr', affiliate: 22000, royalties: 4400, pLevel10: 2200, treasury: 11000 },
    { month: 'May', affiliate: 25000, royalties: 5000, pLevel10: 2500, treasury: 12500 },
    { month: 'Jun', affiliate: 28000, royalties: 5600, pLevel10: 2800, treasury: 14000 }
  ]
      ...
      <div className="enhanced-card-content">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center">
            ...
            <div className="text-[#C0E6FF] text-sm">Total Collected (SUI)</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-[#10B981]">
              {totalDistributed.toLocaleString()}
            </div>
            <div className="text-[#C0E6FF] text-sm">Total Distributed (SUI)</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-[#FFD700]">
              {((totalDistributed / totalCollected) * 100).toFixed(1)}%
            </div>
            <div className="text-[#C0E6FF] text-sm">Distribution Efficiency</div>
          </div>
        </div>
      </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {pieData.map((item) => (
                    <div
                      key={item.name}
                      className="flex items-center justify-between p-2 rounded-lg hover:bg-[#1A2F51]/30 transition-colors cursor-pointer group"
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-[#C0E6FF] text-sm group-hover:text-white transition-colors">
                          {item.name}
                        </span>
                ...
                <div className="mt-3 text-xs text-[#C0E6FF]/70">
            ...
            <div className="h-80 mb-6">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={barData}>
                  ...
                  <Legend />
                  <Bar dataKey="affiliate" stackId="a" fill="#4DA2FF" name="Affiliate" />
                  <Bar dataKey="royalties" stackId="a" fill="#FFD700" name="Royalties" />
                  <Bar dataKey="pLevel10" stackId="a" fill="#8B5CF6" name="P.Level 10" />
                  <Bar dataKey="treasury" stackId="a" fill="#10B981" name="Treasury" />
                </BarChart>
              </ResponsiveContainer>
            </div>

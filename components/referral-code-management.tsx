        ...
        {codes.map((code) => (
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
              ...
              <div className="text-center">
                <div className="text-lg font-semibold text-green-400">{code.successfulConversions}</div>
                <div className="text-xs text-[#C0E6FF] flex items-center justify-center gap-1">
              ...
              <div className="text-center">
                <div className="text-lg font-semibold text-blue-400">{code.totalClicks}</div>
                <div className="text-xs text-[#C0E6FF] flex items-center justify-center gap-1">
              ...
              <div className="text-center">
                <div className={`text-lg font-semibold ${getPerformanceColor(code.conversionRate)}`}>
                  {formatConversionRate(code.conversionRate)}
                </div>
                <div className="text-xs text-[#C0E6FF] flex items-center justify-center gap-1">
            ...
            {/* Description */}
            {code.description && (
              <div className="mt-3 text-sm text-[#C0E6FF]/70">
                {code.description}
              </div>
            )}
          </div>
